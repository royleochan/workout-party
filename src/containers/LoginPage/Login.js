...
class Login extends React.Component {
  ...
  handleSubmit = (e) => {
    e.preventDefault();
    if (
      e.target.name.value === "testuser" &&
      e.target.pass.value === "testuser"
    ) {
        ...
        <div style={{ float: "left", width: "50%" }}>
          <div className="main">
            <div style={{ float: "left", width: "30%", marginLeft: "20%" }}>
              <button
                onClick={(e) => this.setState({ type: "sign" })}
                className="sign"
                align="center"
              >
                Log In
            ...
            <div style={{ float: "left", width: "30%" }}>
              <button
                onClick={(e) => this.setState({ type: "join" })}
                className="sign"
                align="center"
              >
                Quick Join
            ...
            {this.state.type === "sign" && (
              <form className="form1" onSubmit={this.handleSubmit}>
                ...
                <p className="forgot" align="center">
                  <a href="/">New Joiner? Register Here!</a>
                </p>
              </form>
            )}
