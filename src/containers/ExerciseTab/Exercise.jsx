        ...
        >
            {
                hasRoom ?
                    <>
                        ...
                        <div style={{height: 50}} />
                        <h3 style={{fontFamily: "Impact", fontSize: "40px", padding: 10, color: "white"}}>Room ID : {jitsiState.roomName}</h3>
                        <div style={{height: 50}} />
                        <CustomJutsu
                    ...
                    >
                        <h3 style={{fontFamily: "Impact", fontSize: "40px", padding: 10, color: "white"}}>Workout not selected yet</h3>
                        <button
                            className="time-home"
                            style={{
                                marginRight: "5%",
